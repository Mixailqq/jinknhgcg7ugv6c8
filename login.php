...
<body>
  <a href="index2.php" class="button2">Назад</a>
  <div class="container">
      ...
      <div class="col-lg-5">
        ...
        <div class="form-wrap border rounded p-4">
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            <div class="mb-3">
              <label for="user_login" class="form-label">Электронная почта или имя пользователя</label>
            ...
            <div class="mb-3">
              <input type="submit" class="btn btn-primary form-control" name="submit" value="Авторизоваться">
            </div>
          </form>
          <!-- form ends here -->
        </div>
